<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-12">
            <form action="<?= base_url('laporan/cek_laporan_sm') ?>" id="laporan-sm" method="post">
                <div class="form-row">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    <form action="<?= base_url('laporan/export_laporan_sm') ?>" method="post">
...
<script>
    ...
    $(document).ready(function() {
        ...
        $("#laporan-sm").submit(function(e) {
            ...
            $("#laporan-sm input").on('change', function() {
                $(this).removeClass('is-valid is-invalid')
            });
            $("#laporan-sm select").on('change', function() {
                $(this).removeClass('is-valid is-invalid')
            })
        })
    })
