    ...
    <div class="row">
        <div class="col-12">
            <div class="card shadow">
                <div class="card-body">
                    <?= form_open_multipart('sk/ubah_sk', ['id' => 'formUbahSk']); ?>
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="custom-file">
                                    ...
                                    <div class="invalid-feedback"></div>
                                    <small class="text-sm text-info">Format file yang diperbolehkan .PDF dan ukuran maks 5 MB!</small>
                                </div>
                            </div>
...
<script>
    $(document).ready(function() {
        ...
        $("#formUbahSk").submit(function(e) {
            ...
            $("#formUbahSk input").on('keyup', function() {
